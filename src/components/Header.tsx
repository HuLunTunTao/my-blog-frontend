...
export default function Header() {
  return (
    <header className="md:hidden flex items-center justify-between p-6 border-b border-stone-100 dark:border-stone-800/60 bg-background/80 backdrop-blur sticky top-0 z-40">
